...
# daskdata = dd.read_csv('.\Data\Thursday-15-02-2018_TrafficForML_CICFlowMeter.csv')
...
df_goldeneye_columns = df.columns.values.tolist()

column_dict = { }

for n in df_goldeneye_columns:
    old_value = str(n)
...
df.to_csv('.\Data\Optimized\Thursday-15-02-2018_GoldenEye-Attack.csv', index=False)
