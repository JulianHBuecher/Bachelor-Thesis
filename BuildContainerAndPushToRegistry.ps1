function BuildContainer() {
    ...
    docker build -t studentenk8sregistry.azurecr.io/jb-thesis-ml.proxy:v5.0 -f .\ML.Proxy\Dockerfile.Production .\
...
function PushToRegistry() {
    ...
    docker image push studentenk8sregistry.azurecr.io/jb-thesis-ml.proxy:v5.0
